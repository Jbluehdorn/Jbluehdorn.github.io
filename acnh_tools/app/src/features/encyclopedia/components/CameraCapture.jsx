        ...
        <div className="camera-message">
          ...
          <div className="confirm-list">
            ...
            {likelyCollected.length > 0 && (<>
              <div className="cc-section-label">🎨 Likely Collected ({likelyCollected.length})</div>
            ...
            {likelyUncollected.length > 0 && (<>
              <div className="cc-section-label">👤 Likely Uncollected ({likelyUncollected.length})<span className="cc-section-hint"> — check any that are actually collected</span></div>
              <div className="confirm-grid">
